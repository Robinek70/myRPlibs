...
CircularBuffer::CircularBuffer(uint8_t inputSize)
{
...
//
float CircularBuffer::getElement( uint8_t elementNum )
{
  //Translate elementNum into terms of cBufferLastPtr.
  int8_t virtualElementNum;
...
uint8_t CircularBuffer::recordLength( void )
{
